...
[assembly: OwinStartup(typeof(fepuseAPI.Startup))] // en este atributo indico la clase que se dispara una vez que arranca el servidor
namespace fepuseAPI
{
    public class Startup
    {
        ...
        private void ConfigureOAuthTokenGeneration(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(FepuseAPI_Context.Create);
